    ...
    $.post("/Admin/Manage/GetManageData", content, function (retContent) {
        if (retContent.status == 0) {
            ...
            for (var i = 0; i < dataContent.length; i++) {
                ...
                showHtml += '<td class="am-hide-sm-only" data-id="1"><div _switch="" class="am-switch am-round am-switch-success  newDisplay am-active"><div class="am-switch-handle"><input type="checkbox" class="" checked=""></div></div></td>';
                ...
                showHtml += '<a class="am-btn am-btn-default am-btn-xs am-text-secondary" id="btnEdit" data-id="' + dataContent[i].id + '"><span class="am-icon-pencil-square-o"></span> 编辑</a>';
